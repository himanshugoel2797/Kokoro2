...
namespace Kokoro2.Math
{
    ...
    public struct Box2
    {
        ...
        /// </summary>
        /// <param name="topLeft">AnKokoro2.Math.Vector2 describing the top-left corner of the Box2.</param>
        /// <param name="bottomRight">An Kokoro2.Math.Vector2 describing the bottom-right corner of the Box2.</param>
        ...
        /// <param name="right">The position of the right boundary.</param>
        /// <param name="bottom">The position of the bottom boundary.</param>
        /// <returns>A new Kokoro2.Math.Box2 with the specfied dimensions.</returns>
